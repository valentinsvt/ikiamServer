    ...
    <g:form class="form-horizontal" name="frmCoordenada" role="form" action="save_ajax" method="POST">
        ...
        <div class="form-group keeptogether ${hasErrors(bean: coordenadaInstance, field: 'altitud', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-2">
                    <g:field name="altitud" type="number" value="${fieldValue(bean: coordenadaInstance, field: 'altitud')}" class="number form-control  required" required=""/>
                </div>
                 *
            </span>
        </div>
        ...
        <div class="form-group keeptogether ${hasErrors(bean: coordenadaInstance, field: 'latitud', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-2">
                    <g:field name="latitud" type="number" value="${fieldValue(bean: coordenadaInstance, field: 'latitud')}" class="number form-control  required" required=""/>
                </div>
                 *
            </span>
        </div>
        ...
        <div class="form-group keeptogether ${hasErrors(bean: coordenadaInstance, field: 'longitud', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-2">
                    <g:field name="longitud" type="number" value="${fieldValue(bean: coordenadaInstance, field: 'longitud')}" class="number form-control  required" required=""/>
                </div>
                 *
            </span>
        </div>
