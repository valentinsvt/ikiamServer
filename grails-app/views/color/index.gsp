		...
		<div id="list-color" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="color" title="${message(code: 'color.color.label', default: 'Color')}" />
				...
				<g:each in="${colorInstanceList}" status="i" var="colorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${colorInstance.id}">${fieldValue(bean: colorInstance, field: "color")}</g:link></td>
