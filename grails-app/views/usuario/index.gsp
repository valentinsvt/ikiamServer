		...
		<div id="list-usuario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="esCientifico" title="${message(code: 'usuario.esCientifico.label', default: 'Es Cientifico')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: usuarioInstance, field: "esAdmin")}</td>
					
						<td>${fieldValue(bean: usuarioInstance, field: "esCientifico")}</td>
