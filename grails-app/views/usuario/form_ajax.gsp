    ...
    <g:form class="form-horizontal" name="frmUsuario" role="form" action="save_ajax" method="POST">
        ...
        <div class="form-group keeptogether ${hasErrors(bean: usuarioInstance, field: 'email', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-envelope"></i></span><g:field type="email" name="email" class="form-control unique" value="${usuarioInstance?.email}"/></div>
                </div>
        ...
        <div class="form-group keeptogether ${hasErrors(bean: usuarioInstance, field: 'password', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-lock"></i></span><g:field type="password" name="password" maxlength="255" class="form-control" value="${usuarioInstance?.password}"/></div>
                </div>
        ...
        <div class="form-group keeptogether ${hasErrors(bean: usuarioInstance, field: 'esAdmin', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="esAdmin" maxlength="1" required="" class="form-control required" value="${usuarioInstance?.esAdmin}"/>
                </div>
                 *
            </span>
        </div>
        ...
        <div class="form-group keeptogether ${hasErrors(bean: usuarioInstance, field: 'esCientifico', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="esCientifico" maxlength="1" required="" class="form-control required" value="${usuarioInstance?.esCientifico}"/>
                </div>
                 *
            </span>
        </div>
