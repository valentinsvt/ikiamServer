...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'social', 'error')} required">
    <span class="grupo">
        ...
        <div class="col-md-9">
            <textarea name="etimologia" required="" class="form-control required" >
                ${fichaTecnicaAnimalInstance?.etimologia}
            </textarea>
        </div>
        *
    </span>
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'social', 'error')} required">
    <span class="grupo">
        ...
        <div class="col-md-9">
            <textarea name="conservacion" required="" class="form-control required" >
                ${fichaTecnicaAnimalInstance?.conservacion}
            </textarea>
        </div>
        *
    </span>
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'social', 'error')} required">
    <span class="grupo">
        ...
        <div class="col-md-9">
            <textarea name="habitat" required="" class="form-control required" >
                ${fichaTecnicaAnimalInstance?.habitat}
            </textarea>
        </div>
        *
    </span>
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'social', 'error')} required">
    <span class="grupo">
        ...
        <div class="col-md-9">
            <textarea name="taxonomia" required="" class="form-control required" >
                ${fichaTecnicaAnimalInstance?.taxonomia}
            </textarea>
        </div>
        *
    </span>
...
<div class="row${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'especie', 'error')} required">
    <span class="grupo">
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'longevidad', 'error')} required">
    <span class="grupo">
        <label for="longevidad" class="col-md-2 control-label text-info">
            Altura min
        </label>
        <div class="col-md-3">
            <g:field name="alturaMin" type="number" value="${fichaTecnicaAnimalInstance.alturaMin}" class="digits form-control required" required=""/>
        </div>
        *
    </span>
</div>
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'longevidad', 'error')} required">
    <span class="grupo">
        ...
        <div class="col-md-3">
            <g:field name="alturaMax" type="number" value="${fichaTecnicaAnimalInstance.alturaMax}" class="digits form-control required" required=""/>
        </div>
        *
    </span>
</div>
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'longevidad', 'error')} required">
    <span class="grupo">
        ...
        <div class="col-md-3">
            <g:field name="temperaturaMin" type="number" value="${fichaTecnicaAnimalInstance.temperaturaMin}" class="digits form-control required" required=""/>
        </div>
        *
    </span>
</div>
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'longevidad', 'error')} required">
    <span class="grupo">
        ...
        <div class="col-md-3">
            <g:field name="temperaturaMax" type="number" value="${fichaTecnicaAnimalInstance.temperaturaMax}" class="digits form-control required" required=""/>
        </div>
        *
    </span>
</div>
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'longevidadCautiverio', 'error')} required">
    <span class="grupo">
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'pesoMax', 'error')} required">
    <span class="grupo">
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'pesoMin', 'error')} required">
    <span class="grupo">
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'tallaMax', 'error')} required">
    <span class="grupo">
...
<div class="row ${hasErrors(bean: fichaTecnicaAnimalInstance, field: 'tallaMin', 'error')} required">
    <span class="grupo">
