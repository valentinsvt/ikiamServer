                ...
                <tbody>
                    <g:each in="${especieInstanceList}" status="i" var="especieInstance">
                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                            ...
                            <td>
                                <g:link action="show" id="${especieInstance.id}">
                                    ${URLDecoder.decode(especieInstance.nombre, "UTF-8")}
                                </g:link>
                            </td>

                            <td>
                                ${URLDecoder.decode(especieInstance.color1?.color ?: "", "UTF-8")}
                            </td>

                            <td>
                                ${URLDecoder.decode(especieInstance.color2?.color ?: "", "UTF-8")}
                            </td>

                            <td>
                                ${URLDecoder.decode(especieInstance.genero?.nombre, "UTF-8")}
                            </td>

                            <td>
                                ${URLDecoder.decode(especieInstance.nombreComun, "UTF-8")}
                            </td>
