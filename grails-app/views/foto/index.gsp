		...
		<div id="list-foto" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="foto.atraccion.label" default="Atraccion" /></th>
				...
				<g:each in="${fotoInstanceList}" status="i" var="fotoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: fotoInstance, field: "atraccion")}</td>
					
						<td>${fieldValue(bean: fotoInstance, field: "entry")}</td>
