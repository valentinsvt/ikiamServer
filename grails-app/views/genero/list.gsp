...
<html>
    ...
    <!-- botones -->
        ...
        <elm:pagination total="${generoInstanceCount}" params="${params}"/>
        ...
        <script type="text/javascript">
            ...
            function buscar() {
                ...
                location.href = "${createLink(controller: 'genero', action:'list')}?search=" + search;
            }
