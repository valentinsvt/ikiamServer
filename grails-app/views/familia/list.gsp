...
<html>
    ...
    <!-- botones -->
        ...
        <elm:pagination total="${familiaInstanceCount}" params="${params}"/>
        ...
        <script type="text/javascript">
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    ...
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>" +
                              "¿Está seguro que desea eliminar el Familia seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
            ...
            function buscar() {
                ...
                location.href = "${createLink(controller: 'familia', action:'list')}?search=" + search;
            }
